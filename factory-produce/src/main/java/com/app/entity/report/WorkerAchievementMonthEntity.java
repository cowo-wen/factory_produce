 ...
 */
@Entity
@Table(name = "t_report_worker_ach_month")
@TableCache(isCache=true)
public class WorkerAchievementMonthEntity extends CacheVo  implements Serializable
{
    ...
    public WorkerAchievementMonthEntity(JdbcDao jdbcDao) {
		super(jdbcDao);
		// TODO Auto-generated constructor stub
	}
    
    public WorkerAchievementMonthEntity(JdbcDao jdbcDao,Long userId,int countMonth) {
		super(jdbcDao);
		this.userId = userId;
		this.bounty = 0.0;
	...
	public WorkerAchievementMonthEntity setUserId(Long userId) {
		this.userId = userId;
	...
	public WorkerAchievementMonthEntity setCreateTime(Date createTime) {
	...
	public WorkerAchievementMonthEntity setOperatorTime(Date operatorTime) {
	...
	public WorkerAchievementMonthEntity setUserName(String userName) {
